...
var domain = 'testpwa.kuzovkov12.ru';
var fs = require('fs');
var key_file = (fs.existsSync('ssl/' + domain + '/privkey.pem'))? 'ssl/' + domain + '/privkey.pem' : 'ssl/key.pem';
var cert_file = (fs.existsSync('ssl/' + domain + '/cert.pem'))? 'ssl/' + domain + '/cert.pem' : 'ssl/cert.pem';
var options = {
...
const API_KEY = 'a45b1b5f957fb5de0a812627518babbe';//process.env.DARKSKY_API_KEY;
...
function startServer() {
  ...
  server.listen(443,function(){
    console.log('Local DevServer Started on port 443...');
    /*сброс привилегий*/
